      ...
      >
        <div className="container-site flex items-center justify-between h-16 gap-6">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/clearance"
              className="hidden sm:inline-flex items-center justify-center px-5 py-2.5 rounded-sm bg-[var(--color-navy)] text-white text-sm font-medium tracking-wide hover:bg-[var(--color-navy-dark)] transition-colors"
            >
              Arrange Clearance
            </Link>
            <button
      ...
      {open && (
        ...
        >
          ...
          <nav className="absolute top-0 right-0 h-full w-72 bg-[var(--color-ivory)] shadow-2xl flex flex-col pt-20 pb-8 px-8 gap-2">
            ...
            <Link
              href="/clearance"
              className="mt-6 inline-flex items-center justify-center px-5 py-3 rounded-sm bg-[var(--color-navy)] text-white text-sm font-medium hover:bg-[var(--color-navy-dark)] transition-colors"
            >
              Arrange Clearance
            </Link>
          </nav>
