  ...
  return (
    <section className="bg-[var(--color-ivory)]">
      ...
      <div className="w-full">
        <ImgPlaceholder
          label="Sri Lanka — tea country at dawn · elephant at Sigiriya at sunrise · elevated to breathe"
      ...
      <div className="container-site pt-14 pb-20">
        <div className="max-w-2xl">
          <h1
            className="text-5xl sm:text-[3.75rem] lg:text-7xl font-semibold leading-[1.08] text-[var(--color-navy)] mb-8"
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              Arrange Clearance <ChevronDown size={14} />
            </Link>
          </div>
        </div>
      </div>
